...
/// </summary>
public sealed class CameraPluginManager
{
    private static readonly Lazy<CameraPluginManager> _instance = new(() => new CameraPluginManager(),
        LazyThreadSafetyMode.ExecutionAndPublication);

    public static CameraPluginManager Instance => _instance.Value;
